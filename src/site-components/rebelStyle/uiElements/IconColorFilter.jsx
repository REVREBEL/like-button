...
export function IconColorFilter({
  icon = "https://cdn.prod.website-files.com/68ce13370afdfa5ff87473be/68f93fe0beb76445a1d19ca2_6238cdd153083476ac8a079d06a48cf9_computer-graph.svg",
  ...
  return (
    ...
    >
      <Block
        className={`rebel-style--variants_icon-filter-color ${_activeStyleVariant}`}
        tag={"div"}
      >
        <Block
          className={`rebel-style--component_icon-size-wapper ${_activeStyleVariant}`}
          tag={"div"}
        >
          {iconVisibility ? (
            <Image
              className={`rebel-style--icon-variant ${_activeStyleVariant}`}
              height={"auto"}
              loading={"lazy"}
              src={icon}
              width={"auto"}
