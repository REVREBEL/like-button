...
export function ComponentSizeLike(
    {
        ...
        dataDataSlug,
        dataSlugDataMetricLike
    }
) {
    _interactions.useInteractions(_interactionsData);

    const _styleVariantMap = {
        "1x": "w-variant-ba0bb0c4-06ff-1458-ce8c-47c14f87ed46",
        "1.25x": "",
        "1.5x": "w-variant-ba0bb0c4-06ff-1458-ce8c-47c14f87ed47",
        "1.75x": "w-variant-ba0bb0c4-06ff-1458-ce8c-47c14f87ed48",
        "2x": "w-variant-ba0bb0c4-06ff-1458-ce8c-47c14f87ed49"
    };
    ...
    return (
        <_Component
            ...
            tag="div"
            data-storage-key={dataDataSlug}><_Builtin.Block
                className={`rebel-style--component_position rebel-style--is-likes ${_activeStyleVariant}`}
                tag="div">{optionsCountVisibility ? <_Builtin.Block
                    className={`rebel-style--likes_component-size rebel-style--no-hxw-adjustment ${_activeStyleVariant}`}
                    id="w-node-_3987410a-11de-b705-95fe-88cf5a20f56d-5a20f56b"
                    tag="div">{likesLikesCountVisibility ? <_Builtin.Block
                        className={`rebel-style--like-post rebel-style--is-hidden ${_activeStyleVariant}`}
                        tag="div"
                        {...likesLikesCountRuntimeProps}>{likesLikesCountSlot ?? likesLikesCountText}</_Builtin.Block> : null}</_Builtin.Block> : null}{optionsIconVisibility ? <_Builtin.Block
                    className={`rebel-style--likes_component-size rebel-style--is-icon ${_activeStyleVariant}`}
                    tag="div"
                    ...
                    {...likesLikesCountRuntimeProps}><_Builtin.HtmlEmbed
                        ...
                        {...likesLikesCountRuntimeProps} /> : null}</_Builtin.Block> : null}{optionsLabelVisibility ? <_Builtin.Block
                    className={`rebel-style--likes_component-size rebel-style--no-hxw-adjustment ${_activeStyleVariant}`}
                    id="w-node-_3987410a-11de-b705-95fe-88cf5a20f573-5a20f56b"
                    tag="div">{likesLikesLabelVisibility ? <_Builtin.Block
                        className={`rebel-style--like-post ${_activeStyleVariant}`}
                        tag="div"
                        data-unliked-text={likesUnlikedButtonLabelText}
                        data-liked-button={likesLikedButtonLabelText}
                        id="number-likes-count"
                        {...likesLikesCountRuntimeProps}>{likesLikesCountSlot ?? likesLikesLabelText}</_Builtin.Block> : null}</_Builtin.Block> : null}</_Builtin.Block></_Component>
    );
}