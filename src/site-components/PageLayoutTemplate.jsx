...
import { SectionMarginTop } from "./SectionMarginTop";

export function PageLayoutTemplate(
    {
    ...
    return (
        <_Component className="rebel-style--global_page-wrapper" tag="div"><_Builtin.BlockContainer
                ...
                id="fixed-root"><_Builtin.Block
                    ...
                    tag="div" /></_Builtin.BlockContainer><_Builtin.BlockContainer
                className="rebel-style--global_fixed-root"
                grid={{
                    type: "container"
                }}
                ...
                tag="div"><_Builtin.NotSupported _atom="Slot" /><_Builtin.BlockContainer
                    ...
                    tag="div"><_Builtin.Section
                        ...
                        tag="section"><_Builtin.Section
                            ...
                            tag="section"><SectionMarginTop
                                slotSlot={<SectionMarginBottom
                                    slotSlot={<PageVerticalPadding
                                        paddingPaddingVertical="Padding None"
                                        slotSlot={<PageHorizontalPadding paddingPaddingHorizontal="Padding None" />} />} />} /></_Builtin.Section></_Builtin.Section></_Builtin.BlockContainer><_Builtin.NotSupported _atom="Slot" /></_Builtin.BlockContainer></_Component>
    );
}