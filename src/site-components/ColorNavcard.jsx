...
export function ColorNavcard(
    {
        ...
        colorCard1Paragraph = <>{"Where we share our tips and ideas on generating revenueat your property."}<br /></>,

        colorCard1Link = {
            href: "#"
        },

        colorCard2Paragraph = <>{"A collection of trends from the largest travel sites and researchers."}<br /></>,
    ...
    const _styleVariantMap = {
        "Light": "",
        "Dark": "w-variant-8d1f101d-43e1-9694-6bd9-87aaf9784a8d"
    };
        ...
        <_Component
            ...
            tag="div"><_Builtin.Block
                ...
                tag="div"><_Builtin.Link
                    className={`rebel-style--color-navcard rebel-style--is-border-width_3px ${_activeStyleVariant}`}
                    button={false}
                    block="inline"
                    options={colorCard1Link}><_Builtin.Block
                        className={`rebel-style--color-navcard_right-content ${_activeStyleVariant}`}
                        ...
                        tag="div"><_Builtin.Block
                            ...
                            tag="div"><_Builtin.Block className={`rebel-style--navcard_icon ${_activeStyleVariant}`} tag="div"><_Builtin.Image
                                ...
                                className={`rebel-style--navcard_headline rebel-style--dropdown-2_max-width ${_activeStyleVariant}`}
                        ...
                        className={`rebel-style--color-navcard_left-content ${_activeStyleVariant}`}
                ...
                tag="div"><_Builtin.Link
                    className={`rebel-style--color-navcard rebel-style--is-color-2 rebel-style--is-border-width_3px ${_activeStyleVariant}`}
                    button={false}
                    block="inline"
                    options={colorCard2Link}><_Builtin.Block
                        className={`rebel-style--color-navcard_right-content rebel-style--is-inverse_color-2 ${_activeStyleVariant}`}
                ...
                tag="div"><_Builtin.Link
                    className={`rebel-style--color-navcard rebel-style--is-color-5 rebel-style--is-border-width_3px ${_activeStyleVariant}`}
                    button={false}
                    block="inline"
                    options={colorCard3Link}><_Builtin.Block
                        className={`rebel-style--color-navcard_right-content rebel-style--is-inverse-color-5 ${_activeStyleVariant}`}
                ...
                tag="div"><_Builtin.Link
                    className={`rebel-style--color-navcard rebel-style--is-color-8 rebel-style--is-border-width_3px ${_activeStyleVariant}`}
                    button={false}
                    block="inline"
                    options={colorCard4Link}><_Builtin.Block
                        className={`rebel-style--color-navcard_right-content rebel-style--is-inverse-color-8 ${_activeStyleVariant}`}
